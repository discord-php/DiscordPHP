 ...
 *
 * @property string[]  $choices  Choices the applicant can select from.
 * @property ?int|null $response The applicant's response.
 */
class MultipleChoiceFormFieldResponse extends FormFieldResponse
{
    /** @inheritDoc */
    protected $fillable = [
        'field_type',
