 ...
 *
 * @property string[]   $values   Terms the applicant must acknowledge.
 * @property ?bool|null $response Whether the applicant accepted the terms.
 */
class TermsFormFieldResponse extends FormFieldResponse
{
    /** @inheritDoc */
    protected $fillable = [
        'field_type',
