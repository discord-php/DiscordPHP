...
class Webhook extends Part
{
     ...
     * @return Promise
     */
    public function execute($data, array $queryparams = []): Promise
    {
     ...
     * @return Promise
     */
    public function updateMessage(string $message_id, MessageBuilder $builder, array $queryparams = []): Promise
    {
