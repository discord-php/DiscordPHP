 ...
 *
 * @link https://discord.com/developers/docs/components/reference#channel-select
 *
 * @since 10.11.0
 *
 ...
 * @property ExCollectionInterface|DefaultValues[]|null  $default_values List of default values for auto-populated select menu components; number of default values must be in the range defined by min_values and max_values.
