...
/**
 * Abstract class to build common message.
 */
abstract class AbstractMessageBuilder
{
     ...
     *
     * @param ?string|null $content Content of the message. Maximum 2000 characters.
     *
    ...
    {
        if (isset($content) && poly_strlen($content) > 2000) {
