 ...
 * Lobby messages are not cached, so there is no old message.
 *
 * @link https://docs.discord.com/developers/events/webhook-events#lobby-message-update
 *
 * @see \Discord\Parts\Lobby\Message
 *
 * @since 10.59.0
 */
class LobbyMessageUpdate extends Event
{
    /**
     * @inheritDoc
     */
    public function handle($data)
    {
        ...
        return $this->factory->part(Message::class, (array) $data, true);
    }
}
