...
class Discord
{
    ...
    public $colorTable = [
        ...
        'darkorange' => 'ff8c00', 'orange' => 'ffa500', 'gold' => 'ffd700', 'yellow' => 'ffff00',
        ...
        'khaki' => 'f0e68c', 'darkkhaki' => 'bdb76b', 'lavender' => 'e6e6fa', 'thistle' => 'd8bfd8',
        'plum' => 'dda0dd', 'violet' => 'ee82ee', 'orchid' => 'da70d6', 'fuchsia' => 'ff00ff',
        'magenta' => 'ff00ff', 'mediumorchid' => 'ba55d3', 'mediumpurple' => '9370db', 'rebeccapurple' => '663399',
        ...
        'mediumslateblue' => '7b68ee', 'greenyellow' => 'adff2f', 'chartreuse' => '7fff00', 'lawngreen' => '7cfc00',
        ...
        'mediumaquamarine' => '66cdaa', 'darkseagreen' => '8fbc8b', 'lightseagreen' => '20b2aa',
        'darkcyan' => '008b8b', 'teal' => '008080', 'aqua' => '00ffff', 'cyan' => '00ffff', 'lightcyan' => 'e0ffff',
        'paleturquoise' => 'afeeee', 'aquamarine' => '7fffd4', 'turquoise' => '40e0d0', 'mediumturquoise' => '48d1cc',
        'darkturquoise' => '00ced1', 'cadetblue' => '5f9ea0', 'steelblue' => '4682b4', 'lightsteelblue' => 'b0c4de',
        ...
        'mediumslateblue' => '7b68ee', 'royalblue' => '4169e1', 'blue' => '0000ff', 'mediumblue' => '0000cd',
        'darkblue' => '00008b', 'navy' => '000080', 'midnightblue' => '191970', 'cornsilk' => 'fff8dc',
        'blanchedalmond' => 'ffebcd', 'bisque' => 'ffe4c4', 'navajowhite' => 'ffdead', 'wheat' => 'f5deb3',
     ...
     * @return int color
     */
    public function getColor($color = 0): void
    {
        if (is_integer($color)) {
            return $color;
        }
        ...
        if (preg_match('/^([a-z]+)$/ui', $color, $match)) {
            $colorName = str_tolower($match[1]);
            if(isset($this->colorTable[$colorname])) {
                return hexdec($this->colorTable[$colorName]);
            }
        }
