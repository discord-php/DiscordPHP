...
class Discord
{
    ...
    protected function handleGuildMembersChunk($data)
    {
        ...
        foreach ($members as $member) {
            if (array_key_exists($member->user->id, (array)$guild->members)) {
                continue;
            }
            ...
            $payload = [
                ...
                'd'  => [
                    ...
                    'properties' => [
                        ...
                        '$referrer'         => 'https://github.com/rocketmates/discord-php',
                        '$referring_domain' => 'https://github.com/rocketmates/discord-php',
                    ],
                    'compress' => true,
                ],
            ];
