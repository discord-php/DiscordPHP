 ...
 *
 * @method GuildJoinRequest|null get(string $discrim, $key)
 * @method GuildJoinRequest|null pull(string|int $key, $default = null)
 * @method GuildJoinRequest|null first()
 * @method GuildJoinRequest|null last()
 * @method GuildJoinRequest|null find(callable $callback)
 */
class GuildJoinRequestRepository extends AbstractRepository
{
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    protected $class = GuildJoinRequest::class;
     ...
     *
     * @param GuildJoinRequest|string $GuildJoinRequestId The join request id or part.
     ...
     */
    public function action($GuildJoinRequestId, string $action, ?string $rejectionReason = null): PromiseInterface
    {
        if ($GuildJoinRequestId instanceof GuildJoinRequest) {
            $part = $GuildJoinRequestId;
        } else {
            $part = $this->factory->part($this->class, [$this->discrim => (string) $GuildJoinRequestId] + $this->vars, true);
        }
