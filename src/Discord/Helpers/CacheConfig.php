 ...
 * @since 10.0.0
 *
 * @property-read ReactCacheInterface|PSRCacheInterface $interface The PSR-16 cache interface.
...
class CacheConfig
{
    ...
    /**
     * @param ReactCacheInterface|PSRCacheInterface $interface The PSR-16 Cache Interface.
